...
class ExamsReportViewController: UIViewController, ENSideMenuDelegate {
    ...
    override func viewDidLoad() {
        ...
        let alertController = UIAlertController(title: "Oops", message: "ExamsReportViewController", preferredStyle: .Alert)
