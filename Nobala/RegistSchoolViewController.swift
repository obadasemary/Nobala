//
//  RegistSchoolViewController.swift
//  Nobala
//
...
class RegistSchoolViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NobalaClient.sharedInstance().getAdmissionsAndRegistrationo({ (success, errorMessage, myResult) in
            ...
            self.titleLabel.text = self.tableData[0].valueForKey("Title") as? String
            self.textArea.text = self.tableData[0].valueForKey("Description") as? String
