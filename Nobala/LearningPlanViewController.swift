...
class LearningPlanViewController: UIViewController, ENSideMenuDelegate {
    ...
    override func viewDidLoad() {
        ...
        let alertController = UIAlertController(title: "Oops", message: "LearningPlanViewController", preferredStyle: .Alert)
