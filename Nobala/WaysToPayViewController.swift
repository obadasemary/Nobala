...
class WaysToPayViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NobalaClient.sharedInstance().getAdmissionsAndRegistrationo({ (success, errorMessage, myResult) in
            ...
            self.titleLabel.text = self.tableData[2].valueForKey("Title") as? String
            self.textArea.text = self.tableData[2].valueForKey("Description") as? String
